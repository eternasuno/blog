...
const CCIcons = ({
    ...
    return (
        ...
        >
            ...
            {noDerivatives && <ND className={className} />}
            {!noDerivatives && shareAlike && <SA className={className} />}
        </a>
    );
};
...
const NC = ({ className }: { className?: string }) => (
    <span className={className}>
        <svg
            fill="currentColor"
            viewBox="5.5 -3.5 64 64"
...
const ND = ({ className }: { className?: string }) => (
    <span className={className}>
        <svg
            fill="currentColor"
            viewBox="11 -7 64 64"
            ...
            <g>
                ...
                <g>
                    <path
                        ...
                        C51.004,4.842,44.832,2.272,37.557,2.272z M49.615,20.956v5.486H26.358v-5.486H49.615z M49.615,31.243v5.483H26.358v-5.483H49.615z"
                    />
                </g>
            </g>
        </svg>
